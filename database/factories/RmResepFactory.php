...
class RmResepFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'od_add_lensa' => $this->faker->boolean(40) ? $this->faker->randomElement([1.00, 1.25, 1.50, 1.75, 2.00]) : null,
            ...
            'os_add_lensa' => $this->faker->boolean(40) ? $this->faker->randomElement([1.00, 1.25, 1.50, 1.75, 2.00]) : null,
