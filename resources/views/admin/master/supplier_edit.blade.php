    ...
    <div class="bg-white rounded-lg border p-6">
        ...
        <header class="mb-6">
            ...
            <p class="mt-1 text-sm text-gray-600">
                Perbarui informasi supplier frame dan lensa.
            </p>
        </header>
        ...
        <form method="POST" action="{{ route('supplier.update', $supplier->id) }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <x-form-input id="nama_supplier" name="nama" type="text" class="mt-1 block w-full"
                ...
                <div>
                    ...
                    <x-form-input id="kontak" name="kontak" type="text" class="mt-1 block w-full"
                        value="{{ old('kontak', $supplier->kontak) }}" placeholder="08xxxxxxxxxx" />
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('supplier.index') }}" class="text-sm text-gray-600 hover:text-gray-900">
                    Batal
                </a>
            </div>
