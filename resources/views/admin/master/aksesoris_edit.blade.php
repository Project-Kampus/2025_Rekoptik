<x-app-layout>
   ...
   <div class="bg-white rounded-lg border p-6">
      ...
      <form action="{{ route('aksesoris.update', $aksesori->id) }}"
         method="POST"
         class="space-y-6">
         @csrf
         @method('PUT')
         <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
               ...
               <x-text-input
                  name="material"
                  class="w-full"
                  value="{{ old('material', $aksesori->material) }}" />
            </div>
            ...
            <div>
               ...
               <select
                  ...
                  <option value="{{ $supplier->id }}"
                     @selected($supplier->id == $aksesori->supplier_id)>
                     {{ $supplier->nama }}
                  </option>
                  @endforeach
               </select>
