<x-app-layout>
    ...
    @php
        ...
        $lastPembayaran = $pesanan->pembayarans->last();
    @endphp
                                ...
                                <tr class="hover:bg-blue-50">
                                    ...
                                    <td class="px-3 py-2">
                                        ...
                                        @if ($pesanan->status == 'diambil')
                                            ...
                                            {{ $pesanan->pembayarans->last()->tanggal_bayar?->format('d F Y') }}
                                        @else
                                            <span
                                                class="px-2 py-1 mr-2 bg-orange-100 text-orange-700 text-xs font-semibold rounded">
                                                {{ $pesanan->status }}
                    ...
                    <table class="w-full text-sm">
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-indigo-50">
                                ...
                                <td class="px-3 py-2 text-gray-900"> {{ $umur }} Tahun </td>
                            </tr>
                            <tr class="hover:bg-indigo-50">
                ...
                <div class="mb-8">
                    <h4 class="font-semibold text-gray-700 mb-3">
                        ...
                        <span class="text-sm text-gray-500">
                            ({{ $pesanan->pemeriksaan->resep->tanggal?->format('d F Y') }})
                        </span>
                    </h4>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div>
                        ...
                        <p class="font-medium text-gray-900">
                            {{ $pesanan->pengambilan->nama_pengambil ?? '-' }}</p>
                    </div>
                    <div>
                        <p class="text-gray-500 text-sm">Hubungan Pengambil</p>
                        <p class="font-medium text-gray-900">
                            {{ $pesanan->pengambilan->hub_pengambil ?? '-' }}</p>
                    </div>
