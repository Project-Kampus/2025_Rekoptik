    ...
    <div class="bg-white rounded-lg border p-6">
        <header class="mb-6">
            ...
            <p class="mt-1 text-sm text-gray-600">
                Masukkan informasi identitas pasien untuk rekam medis.
            </p>
        </header>

        <form method="POST" action="{{ route('identitaspasien.store') }}" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <textarea id="alamat" name="alamat" rows="3"
                    class="mt-1 block w-full rounded-md border-gray-300 text-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('alamat') }}</textarea>
