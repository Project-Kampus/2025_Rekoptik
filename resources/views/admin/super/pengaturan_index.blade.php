    ...
    <div class="bg-white border rounded-lg p-6">
        ...
        <form method="POST" action="{{ route('pengaturan.update') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <x-form-input name="nama_aplikasi" class="mt-1 block w-full"
                    value="{{ old('nama_aplikasi', $pengaturan->nama_aplikasi ?? '') }}" required />
            ...
            <div>
                ...
                <x-form-input name="nama_toko" class="mt-1 block w-full"
            ...
            <div>
                ...
                <div class="flex items-center gap-4 mt-2">
                    ...
                    @if (!empty($pengaturan->logo))
                        <img src="{{ asset('storage/' . $pengaturan->logo) }}" alt="Logo" class="h-16 rounded border">
                    @else
                    ...
                    <input type="file" name="logo" class="text-sm text-gray-600" accept="image/*">
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <x-form-input name="no_hp" class="mt-1 block w-full"
                        value="{{ old('no_hp', $pengaturan->no_hp ?? '') }}" />
                </div>

                <div>
                    <x-input-label value="Telepon (Telp)" />
                    <x-form-input name="telp" class="mt-1 block w-full"
            ...
            <div>
                ...
                <x-form-input type="email" name="email" class="mt-1 block w-full"
