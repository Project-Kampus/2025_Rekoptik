    ...
    <div class="space-y-6">
        ...
        <div class="bg-white shadow-sm rounded-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>Nama-hub Pengambilan: <strong>{{ $pasien->nama_pengambil ?? '-' }} -
                        {{ $pasien->hub_pengambil ?? '-' }}</strong></div>
                @endif
            </div>
        </div>
        <div class="bg-white shadow-sm rounded-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                @endif
                <div>Dibayar Pasien: <strong>Rp {{ number_format($pasien->dibayar_pasien, 0, ',', '.') }}</strong>
                </div>
