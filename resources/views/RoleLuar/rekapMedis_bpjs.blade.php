         ...
         <table class="min-w-full border border-gray-200 text-sm">
            ...
            <tbody>
               ...
               <tr class="even:bg-gray-50">
                  ...
                  <td class="border px-2 py-1">{{ $rm->od ?? '-' }}</td>
                  <td class="border px-2 py-1">{{ $rm->os ?? '-' }}</td>
                  <td class="border px-2 py-1">{{ $rm->bayar_real ?? '-' }}</td>
                  <td class="border px-2 py-1">{{ $rm->besar_penggantian ?? '-' }}</td>
                  <td class="border px-2 py-1">{{ $rm->selisih ?? '-' }}</td>
               </tr>
               @empty
               <tr>
